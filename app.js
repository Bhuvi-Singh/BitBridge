...
const ICONS = {
  ...
  trophy: `<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 0 1 3 3h-15a3 3 0 0 1 3-3m9 0v-3.375c0-.621-.504-1.125-1.125-1.125h-6.75a1.125 1.125 0 0 1-1.125-1.125V18.75m9.75-14.25c0-.621-.504-1.125-1.125-1.125H6.375c-.621 0-1.125.504-1.125 1.125v1.5c0 2.404 1.745 4.4 4.026 4.793a6.002 6.002 0 0 0 5.448 0A4.877 4.877 0 0 0 18.75 6V4.5Z" /></svg>`,
  fire: `<svg class="icon" viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" d="M12.963 2.286a.75.75 0 0 0-1.071-.136 9.742 9.742 0 0 0-3.539 6.178 7.5 7.5 0 0 1 2.708-2.327.75.75 0 0 1 .918.232c.318.423.501.944.501 1.488 0 1.242-.72 2.37-1.848 2.89a7.48 7.48 0 0 0-3.364 3.738A7.502 7.502 0 0 0 12 22.5a7.5 7.5 0 0 0 7.5-7.5c0-2.883-1.625-5.467-4.148-6.711a.75.75 0 0 0-.916.232 4.484 4.484 0 0 1-1.473 1.265 8.243 8.243 0 0 0 0-7.5Z" clip-rule="evenodd" /></svg>`,
